    ...
    <div class="content">
      <div class="left">
        <a-menu v-model:selectedKeys="selectedKeys" :mode="mode" :theme="theme">
          ...
          <a-menu-item key="2"> 公开设置 </a-menu-item>
          <a-menu-item key="3"> 开通付费设置 </a-menu-item>
        </a-menu>
      </div>
      <div class="right">
        ...
        <template v-else-if="selectedKeys[0] === '2'">
          <div class="title">公开设置</div>
          <div class="publicity-name">
            <div class="name">公开方式</div>
          ...
          <div class="set-eye-org">
            ...
            <div class="set-eye-org-right">
              ...
              <div class="set-button">
                <a-button type="primary" class="but-e" :disabled="!hasSelected">
                  设为可见
                </a-button>
        ...
        <template v-else-if="selectedKeys[0] === '3'">
          <div class="title">开通付费设置</div>
          <div class="pay-radio-group">
            <div class="name">是否付费</div>
            <a-radio-group v-model:value="isPay">
              <a-radio :value="1"> 免费 </a-radio>
              <a-radio :value="2"> 付费 </a-radio>
            </a-radio-group>
          </div>
          <div v-show="isPay == 2" class="pay-name">
            <div class="name">付费金额</div>
            <div class="input">
              <a-input v-model:value.trim="money" placeholder="请输入金额" />
              <span>元</span>
            </div>
          </div>
          <div class="save">
...
<script lang="ts" setup name="EvaluationSet">
import {
  PlusOutlined,
  UploadOutlined,
  LoadingOutlined,
...
const { tags, inputVisible, inputValue } = toRefs(state);
const { mode, theme, selectedKeys } = toRefs(stateMenu);
const { pagination, selectedRowKeys } = toRefs(tableState);
</script>
