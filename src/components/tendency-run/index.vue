      ...
      <a-row :gutter="24">
        ...
        >
          <div class="organization-run">
            <div class="organization-title">机构测评人数排名</div>
            <div
            ...
            >
              <div class="organization-item-left">
                <div class="index" :class="index <= 2 ? 'isThree' : ''">
                  {{ index + 1 }}
                </div>
    ...
    <template #tabBarExtraContent>
      <div class="tabbar-right">
        ...
        <div class="range-picker">
          <a-range-picker v-model:value="pickerValue" :locale="locale" />
        </div>
        <slot />
      </div>
    </template>
...
<script lang="ts" setup name="TendencyRun">
